...
const ProductDetails = () => {
  ...
  const { shortDesc, imgUrl, productName, price, avgRating, reviews, category, description } = product
          ...
          <Row>
            ...
            <Col lg='6'>
              <div className="product__details">
                <h2>productName</h2>
                <div className="product__rating d-flex aling-items-center gap-5 mb-3">
                  <div>
                    <span ><i className="ri-star-s-fill"></i></span>
                    <span ><i className="ri-star-s-fill"></i></span>
                    <span ><i className="ri-star-s-fill"></i></span>
                    <span ><i className="ri-star-s-fill"></i></span>
                    <span ><i className="ri-star-fals-s-line"></i></span>
                  </div>
                    ...
                    <div className="review__form">
                      ...
                      <form action="" onSubmit={submitHandler}>
                        <div className="form__group">
                          <input
                            required
                            type="text" placeholder='Enter name' ref={reviewUser} />
                        </div>
                        ...
                        <div className="form__group">
                          <textarea
                            required
                            ref={reviewMsg}
                            row={4} type="text" placeholder='Review Message...' />
                        </div>
